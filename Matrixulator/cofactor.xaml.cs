...
{
    public partial class cofactor : PhoneApplicationPage
    {
        bool isEmpty = false;
        double[,] matA;
            ...
            if (dim >= 2)
            {
                ...
                for (int a = 0; a < dim; a++)
                {
                    ...
                    for (int b = 0; b < dim; b++)
                    {
                        ...
                        tx1.Padding = new Thickness(5, 5, 5, 5);
                        tx1.FontSize = 20;
        ...
        private void solve_Click_1(object sender, RoutedEventArgs e)
        {
            ...
            if (cfe == false)
            {
                ...
                double[,] holdinv = Matrix.cofactor(forinverse).data;
                for (int q = 0; q < dim; q++)
                {
                ...
                if (dim >= 2)
                {
                    for (int a = 0; a < dim; a++)
                    {
                     //   MessageBox.Show(holdinv[a, 0].ToString());
                        ...
                        for (int b = 0; b < dim; b++)
                        {
                            ...
                            tx3.Padding = new Thickness(10, 10, 10, 10);
