...
{
    //Add a swap button in later versions
    public partial class subtraction : PhoneApplicationPage
    {
        bool rowset = false;
        bool colset = false;
        int row, col, count;
        ...
        private void inflateGrids()
        {
            ...
            for (int a = 0; a < col; a++)
            {
                ...
                for (int b = 0; b < row; b++)
                {
                    ...
                    tx3.Height = 80;
                    tx3.FontSize = 25;
                    tx3.Foreground = new SolidColorBrush(Color.FromArgb(100, 135, 206, 235));
